...
# --- MAIN APP TABS ---
tab_scanners, tab_intraday, tab_swing, tab_option_desk, tab_analytics, tab_backtest = st.tabs(["🔍 Scanners", "💼 Intraday Paper Trades", "📊 Swing Trades", "📈 Option Desk", "📊 Performance Analytics", "📉 Backtesting"])
