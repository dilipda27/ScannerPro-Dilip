...
def run_stage1_proximity_filter(kite, symbols_list, progress_callback=None):
    ...
    logging.info("📋 System checking Stage 1 parameters:")
    logging.info("  🔹 Liquidity: 20-day Volume SMA > 500,000 shares.")
    logging.info("  🔹 Price Proximity: Current close within 3% of 20-day High or 20-day Low.")
    logging.info("  🔹 Consolidation Width: 20-day High to Low range <= 12% (tight consolidation).")
    logging.info("  🔹 Trend Confirmation: Price relative to EMA50 and RSI14 (Bullish: Price > EMA50 & RSI > 50; Bearish: Price < EMA50 & RSI < 50).")
...
def run_stage2_setup_validation(kite, progress_callback=None):
    ...
    logging.info("📋 System checking Stage 2 parameters:")
    logging.info("  🔹 Volatility contraction: 5-day Wilder's ATR < 14-day Wilder's ATR.")
    logging.info("  🔹 Volatility Squeeze tightness: 5-day ATR <= 3.5% of stock price.")
    logging.info("  🔹 Volume contraction: 5-day volume SMA < 20-day volume SMA (Volume dry-up).")
    logging.info("  🔹 Price Horizontal Squeeze: 5-day closing price range <= 4.0%.")
    logging.info("  🔹 Pivot Contraction Waves: contracting depths of recent peaks/troughs.")
